...
## Due to the large sizes of the data files, the complete data (as uploaded on GITHUB) is split and compressed into 3 different files: data_1, data_2 and data_3. 
