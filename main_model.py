...
## THIS SOURCE CODE PERFORMS THE PREDICTION EXERCISE ON A CONVOLUTIONAL NEURAL NETWORK COUPLED WITH LIGHT GRADIENT BOOSTING REGRESSION (LGBR) MODEL

# Load the developed high-dimensional input image from the python file [input_img.py]
data_size = 27587
...
## Extract the high-quality features from the feature-extraction layer and couple the LGBR model for final training
_x = encoder.predict(_input_img) 

# Uncomment line below if you wish to save the trained parameters (weights) of the feature extraction layer
# encoder.save('encoder_enc.h5')

import lightgbm as ltb
from sklearn.model_selection import cross_validate
lgb = ltb.LGBMRegressor(n_estimators=5000)

scoring = ["neg_mean_absolute_error", "neg_mean_squared_error", "r2"]
scores = cross_validate(lgb, _x, y, cv=5, scoring=scoring)
